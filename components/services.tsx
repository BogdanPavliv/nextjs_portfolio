...
const Services = () => {
  return (
    <section id='services' className='z-30 -translate-y-1 bg-secondary overflow-hidden'>
      <div className='container w-full py-[100px] lg:py-[200px]'>
        <div className='flex flex-col justify-between gap-12 px-2 lg:flex-row lg:px-0'>
          ...
          >
            ...
            <p>
            I can help you create an exceptional user interface using modern technologies and advanced practices in front-end development.
            </p>
            ...
            <div className='flex items-center space-x-6 bg-primary p-4'>
              ...
              <div>
                ...
                <p>
                  ...
                  react/next js or HTML with tailwind css
                </p>
              </div>
            </div>
            <div className='flex items-center space-x-6 bg-primary p-4'>
